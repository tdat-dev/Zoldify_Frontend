...
export default function CreateAddressPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast(err.response?.data?.message || 'Lỗi khi lưu địa chỉ', 'error');
    } finally {
      setSaving(false);
    }
  };
  ...
  return (
    <div className="bg-gray-100 min-h-screen pb-20 md:pb-10">
      <div className="max-w-[600px] mx-auto px-4 pt-4">
        ...
        <h1 className="text-2xl font-medium text-gray-800 mb-6">Thêm địa chỉ mới</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-sm p-6 space-y-5">
          <div>
            ...
            <input
              ...
              className="mt-2 w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EE4D2D] focus:border-transparent outline-none"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#EE4D2D] focus:border-transparent outline-none"
          ...
          <div className="flex gap-3 pt-4">
            <Link href="/addresses" className="flex-1 py-3 border border-gray-300 text-gray-700 rounded-lg text-center hover:bg-gray-50 transition-colors">
              Hủy
            </Link>
            <button
              type="submit"
