      ...
      <div className="max-w-[800px] mx-auto px-4 pt-4">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-lg shadow-sm p-8 text-center">
            ...
            <p className="text-gray-500 mb-4">Thêm địa chỉ giao hàng để đặt hàng nhanh hơn</p>
        ...
        <div className="mt-6 text-center">
          <Link href="/profile" className="text-gray-500 hover:text-[#EE4D2D] transition-colors inline-flex items-center">
