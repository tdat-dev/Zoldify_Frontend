        ...
        {loading ? (
          ...
          <table className="w-full">
            <thead className="bg-gray-50 border-b">
              <tr>
                <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase">Sản phẩm</th>
                <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase">Danh mục</th>
                <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase">Giá</th>
                <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase">Số lượng</th>
                <th className="text-left py-4 px-6 text-xs font-semibold text-gray-500 uppercase">Người bán</th>
              ...
              {products.length === 0 ? (
                ...
                products.map((product) => (
                  <tr key={product.id} className="hover:bg-gray-50 transition">
                    ...
                    <td className="py-4 px-6 text-sm font-medium text-red-500 whitespace-nowrap">
