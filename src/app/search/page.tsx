...
export default function SearchPage() {
  ...
  const [trendingKeywords, setTrendingKeywords] = useState<string[]>(() =>
    ["laptop", "books", "phones", "headphones", "tshirts", "shoes"].map((k) =>
      t(`trend_${k}`),
    ),
  );
    ...
    <>
      ...
      <div>
        ...
        <select
          ...
          value={sort}
          onChange={(e) =>
            router.push(urlWith({ sort: e.target.value || null }))
          }
      ...
      <div className="mx-auto max-w-[1500px] px-3 py-3">
        <div className="flex flex-col gap-3 lg:flex-row">
          ...
          <aside className="lg:w-[220px] lg:shrink-0">
            <div className="hidden rounded-card bg-surface-card p-4 lg:sticky lg:top-20 lg:block">
              {filters}
            </div>
                ...
                <div className="rounded-card bg-surface-card pb-10">
                  ...
                  {trendingKeywords.length > 0 && (
                    <div className="mt-8 text-center">
                      <p className="mb-3 text-caption font-normal text-ink-muted">
                        {t("trending")}
                      </p>
              ...
              >
                {pageList().map((p, i) =>
                  p === "gap" ? (
                    <span
                      key={`gap-${i}`}
                      className="px-2 py-1.5 text-small text-ink-faint"
                    >
                      …
                    </span>
                  ) : (
