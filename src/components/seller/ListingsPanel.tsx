...
/**
 * "Tin đã đăng" — nay là MỘT TAB của trang "Đơn bán của tôi" (/shop/orders),
 * không còn là một route riêng trong khu Hồ sơ. Nội dung và chức năng giữ
 * nguyên (bảng tin, chỉnh tồn kho tại dòng, sửa/xoá, phân trang); chỉ đổi chỗ
 * ở để người bán quản lý tin rao và đơn bán trong cùng một màn hình.
 */
